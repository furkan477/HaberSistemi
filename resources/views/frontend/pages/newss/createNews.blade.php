...
<br><br><br>
        <div class="container" style="margin-left: 15.5%;">
            <h2 style="margin-left: 13.0%;">Blog Haber | 7/24 Güncel Haber | Haber Yayınlama</h2><br><br><br>
            <div class="col-md-10">
            @if ($errors)
            ...
            <div class="card card-yellow">
                ...
                <form class="form-horizontal" method="post" role="form" action="{{route('news.create')}}">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" name="subject" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="inputDescription">Haberinizin İçeriği</label>
                            <textarea id="inputDescription" name="news" class="form-control" rows="4"></textarea>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
