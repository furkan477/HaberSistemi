              ...
              <div class="col-md-7"> 
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    ...
                    <p class="text-muted text-center">{{ $userprofile->job }}</p>
                  </div>
                </div>
                      ...
                      <div class="active tab-pane" id="activity">
                        <div class="post">
                          <div class="user-block">
                            ...
                            <span class="username">
                              <a href="#">{{$userprofile->name}} Hakkında</a>
                            </span>
                          </div>
                          <p>
